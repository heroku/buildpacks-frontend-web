...
pub(crate) const DETECT_PROVIDES_WEBSITE_PUBLIC_HTML: &str = formatcp!("{DETECT}.provides_website_public_html");
pub(crate) const DETECT_REQUIRES_WEBSITE_PUBLIC_HTML: &str = formatcp!("{DETECT}.requires_website_public_html");
