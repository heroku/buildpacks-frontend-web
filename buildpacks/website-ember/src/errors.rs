...
fn on_buildpack_error(error: WebsiteEmberBuildpackError, logger: Box<dyn StartedLogger>) {
    match error {
        ...
        WebsiteEmberBuildpackError::ReadPackageJson(e) => on_read_package_json_error(&e, logger),
        WebsiteEmberBuildpackError::ParsePackageJson(e) => on_parse_package_json_error(&e, logger),
