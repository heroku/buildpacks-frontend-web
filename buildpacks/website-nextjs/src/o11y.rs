...
pub(crate) const DETECT_PROVIDES_WEBSITE_NEXTJS: &str =
    formatcp!("{DETECT}.provides_website_nextjs");
pub(crate) const DETECT_REQUIRES_WEBSITE_NEXTJS: &str =
    formatcp!("{DETECT}.requires_website_nextjs");
