...
fn buildpack_error_message(error: WebsiteViteBuildpackError) -> ErrorMessage {
    match error {
        WebsiteViteBuildpackError::Detect(e) => ErrorMessage {
            message: formatdoc! {"
        ...
        WebsiteViteBuildpackError::ReadPackageJson(e) => ErrorMessage {
            message: formatdoc! {"
        ...
        WebsiteViteBuildpackError::ParsePackageJson(e) => ErrorMessage {
            message: formatdoc! {"
        ...
        WebsiteViteBuildpackError::SettingBuildPlanMetadata(e) => ErrorMessage {
            message: formatdoc! {"
...
fn framework_error_message(error: &libcnb::Error<WebsiteViteBuildpackError>) -> ErrorMessage {
    ErrorMessage {
        message: formatdoc! {"
        ...
        error_id: "website_vite_buildpack_error".to_string(),
    }
}
