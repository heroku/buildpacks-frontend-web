...
fn on_buildpack_error(error: WebsiteViteBuildpackError, logger: Box<dyn StartedLogger>) {
    match error {
        WebsiteViteBuildpackError::Detect(e) => on_detect_error(&e, logger),
        WebsiteViteBuildpackError::ReadPackageJson(e) => on_read_package_json_error(&e, logger),
        WebsiteViteBuildpackError::ParsePackageJson(e) => on_parse_package_json_error(&e, logger),
...
fn on_framework_error(
    error: &libcnb::Error<WebsiteViteBuildpackError>,
