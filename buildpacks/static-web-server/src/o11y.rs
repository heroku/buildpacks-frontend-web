...
pub(crate) const CONFIG_CADDY_SERVER_OPTS_BASIC_AUTH: &str = formatcp!("{CONFIG}.caddy_server_opts_basic_auth");
pub(crate) const CONFIG_CADDY_SERVER_OPTS_TEMPLATES: &str = formatcp!("{CONFIG}.caddy_server_opts_templates");
pub(crate) const CONFIG_CADDY_SERVER_OPTS_ACCESS_LOGS: &str = formatcp!("{CONFIG}.caddy_server_opts_access_logs");
...
pub(crate) const CONFIG_RESPONSE_HEADERS_ENABLED: &str = formatcp!("{CONFIG}.response_headers_enabled");
