...
- Updated `heroku/static-web-server` to `2.2.0`.
- Updated `heroku/website-ember` to `2.2.0`.
- Updated `heroku/website-nextjs` to `2.2.0`.
- Updated `heroku/website-vite` to `2.2.0`.
...
- Updated `heroku/website-ember` to `2.0.0`.
